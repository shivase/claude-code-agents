...
func ShowUsage() {
	...
	fmt.Println("  --init             Initialize system (create directories and config files)")
	...
	fmt.Println("  claude-code-agents --init                    # Initialize system")
	fmt.Println("  claude-code-agents --init --force            # Overwrite and initialize")
	fmt.Println("")
